  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="item active">
        <img src="G:\bootstrap\manoj.jpg" alt="Chania" width="800" height="800">
      ...
      <div class="item">
        <img src="G:\bootstrap\foot.jpg" alt="Chania" width="800" height="800">
        <div class="carousel-caption">
          <h3>Footwear</h3>
      ...
      <div class="item">
        <img src="G:\bootstrap\electronicgadgets.jpg" alt="Flower" width="800" height="800">
        <div class="carousel-caption">
      ...
      <div class="item">
        <img src="G:\bootstrap\furniture.jpg" alt="Flower" width="800" height="800">
        <div class="carousel-caption">
  ...
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#" style = "color:cyan">@inone store</a><br>
       ...
       <li ><a href="file:///G:/bootstrap/log.html" style = "color:cyan"><span class="glyphicon glyphicon-user"></span>LOG IN</a></li>
